        ...
        <div class="col-xxl-9">
          <div class="row">
            <div class="col-xl-4 col-lg-6">
              <div
                class="card bg-primary bg-gradient text-white visa-card mb-0"
              >
                <div class="card-body">
                  <div>
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0 me-3">
                      <div class="avatar">
                        <div
                          class="avatar-title rounded bg-primary bg-gradient"
                        >
                          <eva-icon
                            name="shopping-bag"
                            class="fill-white"
                  ...
                  >
                    <div>
                      ...
                      <ul class="list-unstyled mb-0">
                        ...
                        <li class="pt-2">
                          <a href="#" class="btn btn-link w-100 shadow-none"
                            ><i class="mdi mdi-loading mdi-spin me-2"></i> Load
                            More</a
                          >
                        </li>
                      </ul>
                        ...
                        <div class="d-flex gap-2">
                          ...
                          >
                            <eva-icon
                              ...
                              data-eva-height="14"
                              data-eva-width="14"
                              class="fill-white align-text-top"
                            ></eva-icon>
                          </button>
                          <button
                            type="button"
